package com.example.msufpnotificationapp.datastore
...
import com.example.msufpnotificationapp.util.Constants.ON_BOARDING_STATUS
import com.example.msufpnotificationapp.util.Constants.ON_BOARDING_STATUS_KEY
import kotlinx.coroutines.flow.Flow
import kotlinx.coroutines.flow.map

class OnBoardingDatabase(private val context: Context) {
